...
// @downloadURL  https://gist.github.com/kewne7768/83ca37b9a7dbcd5a1b04c5dee3a134c8/raw/evolve_automation.user.js
// @updateURL    https://gist.github.com/kewne7768/83ca37b9a7dbcd5a1b04c5dee3a134c8/raw/evolve_automation.meta.js
// @author       Fafnir
// @author       TMVictor
// @author       Vollch
// @author       schoeggu
...
(function($) {
    ...
    class SnippetEditorManager {
        ...
        static getTsDecl() {
            ...
            // Very ugly, but to debug this, edit any snippet and run:
            // autoEvolve.SnippetEditorManager._currentlyEditingMonaco.setModel(monaco.editor.getModels()[0])
            return `
export {};
declare global {
    ...
    const settings: { [key: string]: string|number|object; };
    ...
    const settingsRaw: { [key: string]: string|number|object; };
    ...
    function _<EvalFn extends EvalFnCheckType>(checkType: EvalFn, arg: EvalFnArg<EvalFn>): any;
    interface CheckTypeFn<EvalFn extends EvalFnCheckType> { (arg: EvalFnArg<EvalFn>): any; }
    const checkTypes: {
        [EvalFn in EvalFnCheckType]: CheckTypeFn<EvalFn>;
    };
