    ...
    class SnippetManager {
            ...
            for (let snip of snippetsWithUi) {
                ...
                for (let uiElement of ui.elements) {
                    switch (uiElement.type) {
                        case "string":
                            addSettingsString(snipRoot, uiElement.setting, uiElement.label, uiElement.hint ?? "");
                            break;
                        case "number":
                            addSettingsNumber(snipRoot, uiElement.setting, uiElement.label, uiElement.hint ?? "");
                            break;
                        case "toggle":
                            addSettingsToggle(snipRoot, uiElement.setting, uiElement.label, uiElement.hint ?? "");
                            break;
                        case "button":
                            // TODO
                            //add(snipRoot, uiElement.setting, uiElement.label, uiElement.hint ?? "");
                            break;
        ...
        static #makeUi(snip) {
            ...
            const addArr = (hashedParts, unhashedParts) => {
                hashedParts.setting = settingForKey(hashedParts.key);
            ...
            return {
                ...
                toggle: (key, label, defValue, hint) => {
                    ...
                    addArr({ type: "toggle", key, label, hint });
                ...
                string: (key, label, defValue, hint) => {
                    ...
                    addArr({ type: "string", key, label, hint });
                    let settingKey = settingForKey(key);
                ...
                number: (key, label, defValue, hint) => {
                    ...
                    addArr({ type: "number", key, label, hint });
                    let settingKey = settingForKey(key);
                ...
                button: (key, label, hint) => {
                    ...
                    addArr({ type: "button", key, label, hint });
